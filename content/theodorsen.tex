...
More importantly, our simple model of oscillating foil may shed some different light on the mechanism for the selection of optimal frequency for energy harvesting than that reported previously.
